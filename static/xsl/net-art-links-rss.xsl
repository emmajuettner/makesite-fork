...
<html>
  ...
  <body>
    <div id="explanation">
      <h1>Net Art Links Collected by Emma - RSS Feed</h1>
      <p>This is an RSS feed, which allows you to read the latest updates from my Net Art Links page.
	  You can use the URL of this page to subscribe to this feed in an RSS reader.</p>
	  <p><a href="/net-art-links">Return to the main page</a></p>
    </div>
    <div id="content">
